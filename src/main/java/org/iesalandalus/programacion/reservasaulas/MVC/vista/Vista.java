...
public class Vista{
	...
	public void insertarAula() {
		...
		try {
			...
			System.out.print("Aula insertada con éxito.");
	...
	public void insertarProfesor() {
		...
		try {
			...
			System.out.print("Profesor insertado con éxito.");
	...
	public void listarProfesores() {
		...
		if (profesores.length> 0) {
			...
			System.out.print(ERROR + "No existen profesores en la lista. Ingrese un profesor en el sistema.");
		}
	}
